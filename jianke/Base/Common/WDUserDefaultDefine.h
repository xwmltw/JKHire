...
//小红点
static NSString* const WDUserDefault_PersonalServiceRedPoint         = @"WDUserDefault_PersonalServiceRedPoint";
static NSString* const WDUserDefault_PersonalServiceTabBarRedPoint         = @"WDUserDefault_PersonalServiceTabBarRedPoint";
static NSString* const WDUserDefault_JobManageServiceRedPoint         = @"WDUserDefault_JobManageServiceRedPoint";
