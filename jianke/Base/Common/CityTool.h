...
+ (void)getAllCityFromCacheWithBlock:(MKBlock)block; /*!< 所有城市 */


+ (void)getVIPCityArrayWithBlock:(MKBlock)block;    /*!<  VIP城市筛选 */
+ (void)getVIPCityFirstLetterArrayWithBlock:(MKBlock)block; /*!<  VIP城市首字母数组 */
+ (void)getAllSortVIPCityWithBlock:(MKBlock)block;  /*!<  按首字母排序好的所有开通VIP服务的城市 */
@end
