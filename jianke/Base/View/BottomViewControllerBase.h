...
typedef NS_ENUM(NSInteger, DisplayType) {
    ...
    DisplaytypeBannerWithDismiss,
    DisplaytypeBannerWithBottom,
    DisplayTypeTableViewAndLeftRightBottom,
    DisplayTypeTableViewAndLeftRightEspectBottom,
};

typedef NS_ENUM(NSInteger, BannerBtnActiontype) {
    BannerBtnActiontype_AD = 100,
    BannerBtnActiontype_Dissmiss,
};
...
/** 底部按钮顶部边距
    (DisplayTypeTableViewAndLeftRightBottom 和
   DisplayTypeTableViewAndLeftRightEspectBottom有效)
 */
@property (nonatomic,assign) CGFloat marginTopY;
...
/** 顶部广告 */
@property (nonatomic, weak) XZBannerView *XZTopBanner;
