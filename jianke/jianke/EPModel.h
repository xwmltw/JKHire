...
@property (nonatomic, copy) NSString *industry_name;  /*!< 所属行业name */
...
//V315
@property (nonatomic, copy) NSNumber *job_exam_vip; /*!< 岗位是否免审 */

//V321
@property (nonatomic, copy) NSString *extra_verify_pic_url; /*!< 其他认证图片url */

//V323
@property (nonatomic, copy) NSNumber *account_vip_type; /*!< 账号对应的会员类型，无下发该字段：代表非会员 DIAMONDS_VIP(1, "钻石会员"),PLATINUM_VIP(2, "铂金会员"),GOLD_VIP(3, "黄金会员"),SILVER_VIP(4, "白银会员"), BRONZE_VIP(5, "青铜会员"),*/
