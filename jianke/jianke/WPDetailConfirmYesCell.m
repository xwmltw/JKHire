...
- (void)btnEmployOnclick:(UIButton*)sender{
    ...
    WEAKSELF
    [[UserData sharedInstance] entEmployApplyJobWithWithApplyJobIdList:@[_jkModel.apply_job_id.stringValue] jobId:nil employStatus:@(1) employMemo:nil block:^(ResponseInfo *response) {
        [UIHelper toast:@"录用成功"];
