...
@property (nonatomic, copy) NSString *reject_reason;    /*!< 不通过原因 */

@property (nonatomic, copy) NSNumber *verifiy_status;   /*!< 身份证认证状态 */
...
@property (nonatomic, copy) NSString* true_name;
@property (nonatomic, copy) NSString* profile_url;
@property (nonatomic, copy) NSString* ent_short_name;
@property (nonatomic, copy) NSString* desc;
@property (nonatomic, copy) NSNumber* city_id;
@property (nonatomic, copy) NSNumber* industry_id;
@property (nonatomic, copy) NSString* industry_desc;
@end
...
@property (nonatomic, copy) NSNumber *job_type;     /*!< 岗位类型，1普通岗位 2抢单岗位 3：代发岗位 4:快招岗位 5:限制岗位 如果没传这个字段，默认是1*/
@end
...
@interface InsurancePolicyParamModel : ParamModel

@property (nonatomic, copy, nullable) NSString *insured_telephone;   /*!< 被投保人手机号 */
@property (nonatomic, copy, nullable) NSString *insured_true_name;    /*!< 被投保人姓名 */
@property (nonatomic, copy, nullable) NSString *insured_id_card_num;  /*!< 被投保人身份证号 */
@property (nonatomic, copy, nullable) NSArray *insurance_date_list;   /*!< 购买保险的天数 */
@property (nonatomic, copy, nullable) NSNumber *insured_sex;    /*!< 被投保人性别 */
@property (nonatomic,copy, nullable) NSNumber *insurance_status;  /*!< 保险单状态 1已创建 2已结束 */
@property (nonatomic,copy, nullable) NSNumber *insurance_close_status;    /*!< 保险单结束状态 1成功 2失败 */

// 自定义字段
@property (nonatomic, assign) CGFloat pingan_unit_price_ent;    /*!< 平安投保单价 */
@property (nonatomic, copy, nullable) NSArray *insurance_date_history_list;   /*!< 之前已购买保险的天数 */
@property (nonatomic, assign) CGFloat all_pay_money_for_insurance;  /*!< 总投保金额 */
@property (nonatomic, assign) BOOL isBuyForJK;  /*!< 是否是为报名的兼客买保险 */
@property (nonatomic, copy, nullable) NSString *insured_id_card_num_star;  /*!< 被投保人身份证号(星号) */

/** 在兼客管理的投保用 */
- (void)setValueWithDic:(nullable NSDictionary *)resultDic;

@end


@interface PinganInsuranceModel : ParamModel

@property (nonatomic, copy, nullable) NSNumber *total_amount;
@property (nonatomic, copy, nullable) NSArray *insurance_policy_list;

@end

@interface RechargeRecruitParam : ParamModel

@property (nonatomic, copy, nullable) NSNumber *total_amount; /*!< 订单总额，单位为分 */
@property (nonatomic, copy, nullable) NSNumber *recruit_job_num;  /*!< 在招岗位数 */
@property (nonatomic, copy, nullable) NSNumber *recruit_keep_months;  /*!< 在招岗位数持续月份数 */
@property (nonatomic, copy, nullable) NSNumber *recruit_city_id;  /*!< 招聘城市id */
@property (nonatomic, copy, nullable) NSNumber *record_id;    /*!< 招岗位数记录id */


@end


@interface QueryTalentParam : ParamModel

@property (nonatomic, copy, nullable) NSNumber *list_type;    /*!< 查询列表类型：1查询意向兼客 2查询同城兼客 */
