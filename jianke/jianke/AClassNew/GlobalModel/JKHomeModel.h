...
@property (nonatomic, copy) NSNumber *entry_id;
@property (nonatomic, copy) NSString *entry_icon;
@property (nonatomic, copy) NSString *entry_title;
@property (nonatomic, copy) NSString *service_classify_name;

@property (nonatomic, assign, getter=isSelected) BOOL selected;  /*!< 自定义 选中状态 */
...
@property (nonatomic, copy) NSNumber* ad_type;          /*!< 1:应用内打开链接 2:岗位广告  3:浏览器打开链接 4:专题类型  5：应用内打开原生页面*/
