...
+ (void)getAppStorVersion:(MKBlock)block{
    
    AFHTTPRequestOperationManager *manager = [AFHTTPRequestOperationManager manager];
    [manager POST:@"https://itunes.apple.com/lookup?id=1168227626" parameters:nil success:^(AFHTTPRequestOperation * _Nonnull operation, id  _Nonnull responseObject) {
...
//        NSLog(@"当前版本为：%@", dict[@"version"]);
        ...
        MKBlockExec(block,dict[@"version"]);
