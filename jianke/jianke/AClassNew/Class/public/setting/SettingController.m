...
//    [ary2 addObject:@(SettingCellType_help)];
//    [ary2 addObject:@(SettingCellType_notice)];
//    [ary2 addObject:@(SettingCellType_reputably)];  //赏个好评

    [ary2 addObject:@(SettingCellType_clearCache)];
//    if (cityModel.contactQQ.length) {
//        [ary2 addObject:@(SettingCellType_contactMgr)];
//    }
    
    [ary2 addObject:@(SettingCellType_aboutAPP)];
//    [ary2 addObject:@(SettingCellType_switchJK)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.textColor = [UIColor XSJColor_tGrayDeepTransparent80];
    ...
    switch (type) {
        ...
        {
            cell.imageView.image = [UIImage imageNamed:@"v1_set_account"];
        ...
        {
            cell.imageView.image = [UIImage imageNamed:@"v1_set_feedback"];
            cell.textLabel.text = @"意见反馈";
        }
            break;
        case SettingCellType_help:
        {
            cell.imageView.image = [UIImage imageNamed:@"v1_set_guide"];
            cell.textLabel.text = @"帮助中心";
        }
            break;
        case SettingCellType_notice:
        {
            cell.imageView.image = [UIImage imageNamed:@"v1_set_notify"];
        ...
        case SettingCellType_aboutAPP:{
            cell.imageView.image = [UIImage imageNamed:@"v1_set_info"];
            cell.textLabel.text = @"关于优聘";
            break;
        }
        case SettingCellType_clearCache:
        {
            cell.imageView.image = [UIImage imageNamed:@"v1_set_clear"];
        ...
        case SettingCellType_logout:{       // 退出登录
            ...
            break;
        case SettingCellType_contactMgr:{
            cell.imageView.image = [UIImage imageNamed:@"v1_set_contact"];
            cell.textLabel.text = @"联系运营经理";
        }
            break;
        case SettingCellType_switchJK:{
            cell.imageView.image = [UIImage imageNamed:@"v1_set_switch"];
            cell.textLabel.text = @"关于优聘";
        }
            break;
    }
