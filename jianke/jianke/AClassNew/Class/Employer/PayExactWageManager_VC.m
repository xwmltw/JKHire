...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"发放记录" style:UIBarButtonItemStylePlain target:self action:@selector(pushSalaryRecord)];
