...
@property (nonatomic, assign) BOOL isShowPersonalServiceRedPoint;   /*!< 是否显示个人服务管理顶部小红点 */
@property (nonatomic, assign) BOOL isShowJobManageServiceRedPoint;  /*!< 是否显示岗位管理顶部小红点 */
