...
- (void)initBotView{
    ...
    [self.btnAgree setImage:[UIImage imageNamed:@"v318_selected_rect_icon"] forState:UIControlStateSelected];
    ...
    [btnAgreeAuth setTitle:@"《兼客优聘企业服务协议》" forState:UIControlStateNormal];
...
- (void)btnAddJiankeOnclick:(UIButton*)sender{
    ...
    vc.title = @"添加发放对象";
    vc.fromViewType = FromViewType_PayView;
