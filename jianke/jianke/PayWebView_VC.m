...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [WDNotificationCenter addObserver:self selector:@selector(payUrlOrderCallBack:) name:AlipayResponseNotification object:nil];
}
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType{
    ...
    if ([scheme isEqualToString:@"https"] && self.isUnSaftLinks) {
    ...
    if ([urlStr hasPrefix:@"jiankeapp://"] || [urlStr hasPrefix:@"JKHireapp://"]) {
        return NO;
    }
    return YES;
}
