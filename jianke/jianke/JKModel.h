...
@property (nonatomic, copy) NSNumber* id_card_verify_status;    /*!< 实名认证状态: 1：未认证，2：认证中，3：已认证 4:认证失败 */
...
@property (nonatomic, copy) NSString *desc; /*!< 简历描述 */
...
@property (nonatomic, strong) ContactModel *contact;                /*!< 弃用******联系方式 */
...
@property (nonatomic, copy) NSNumber *education;    /*!< 学历类型：1大专2本科3硕士4博士5其他 */
...
@property (nonatomic, copy) NSNumber *ent_contact_resume_log_id;/*!<雇主联系兼客记录id*/
@property (nonatomic, copy) NSNumber *ent_get_free_resume_num; /*!< 企业获赠的简历数*/
@property (nonatomic, copy) NSArray *resume_experience_list;    /*!< 工作经历列表 */
@property (nonatomic, copy) NSDictionary *subscribe_job_info;    /*!<  意向信息  */
@property (nonatomic, copy) NSString *complete; /*!< 简历完整度 */
@property (nonatomic, copy) NSNumber *ent_left_resume_num;  /*!< 查看简历的雇主剩余的简历数 */
@property (nonatomic, copy) NSNumber *age;  /*!< 年龄 */
//v3.2.6
@property (nonatomic, copy) NSNumber *resume_view_num; /*!< 简历被查看次数*/
...
@property (nonatomic,assign) BOOL isHasCheck;   /*!< 是否成功校验姓名 发放工资 手动补录 */
@property (nonatomic,assign) BOOL isNeedCheck;   /*!< 是否需要校验姓名 发放工资 手动补录 */

#pragma mark - ***** 网络请求返回 *****
@property (nonatomic, copy) NSNumber *contact_time ;        /*!< 联系时间：时间的毫秒数 */
@property (nonatomic, copy) NSString *stu_telephone;        /*!< 兼客联系电话 */
...
@interface SoonExpiredResume : NSObject
@property (nonatomic, copy) NSNumber *soon_expired_time; /*!< 过期时间戳 */
@property (nonatomic, copy) NSNumber *soon_expired_num;  /*!< 快过期的简历数 */
@end
