...
- (void)componentRequestStrWithMenu:(JSDropDownMenu *)menu{
    ...
    if (self.timeIndex != 0) {
        ...
        NSString *timeCondition = [NSString stringWithFormat:@", left_time_type:%ld", (long)model.index];
    ...
    if (self.unitIndex != 0) {
        ...
        NSString *moneyCondition = [NSString stringWithFormat:@", salary_unit:%ld", (long)model.index];
