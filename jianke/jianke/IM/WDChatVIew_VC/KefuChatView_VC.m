...
//    self.messageTableView.backgroundColor = [UIColor colorWithRed:0.902 green:0.902 blue:0.902 alpha:1];
    ...
    [quietBtn setImage:[UIImage imageNamed:@"v3_msg_ring_0"] forState:UIControlStateNormal];
    [quietBtn setImage:[UIImage imageNamed:@"v3_msg_ring_1"] forState:UIControlStateSelected];
