...
@property (nonatomic, copy) NSNumber *insurance_record_id;   /*!< 被投保人接口需要 */
...
typedef NS_ENUM(int, WdSystemNoticeType){
    ...
    WdSystemNoticeType_EntServicePersonalInvite = 89,       // 89:雇主个人服务邀约
    WdSystemNoticeType_StuAgreeServicePersonalInvite = 90,       // 90:兼客同意个人服务邀约
    WdSystemNoticeType_EntServiceTeamOrder = 91,       // 91:雇主预约团队服务
    ...
    WdSystemNoticeType_BuyInsuranceFail = 94,       // 94:兼职保险失败
    WdSystemNoticeType_PersonalServiceOrderBackouted = 96,       // 96:个人服务需求被下架
    WdSystemNoticeType_RedirectJobRecuitJobNumPage = 97,       // 96:跳转【在招岗位数】页面
    WdSystemNoticeType_RedirectJobRefreshVasSpreadPage = 98,    //98:跳转【刷新推广】页面
    WdSystemNoticeType_RdirectAccountVipRechargePage = 99,  //99:跳转会员购买页面
    REDIRECT_ACCOUNT_RESUME_RECHARGE_PAGE = 100, //100:跳转简历数购买页面
};
