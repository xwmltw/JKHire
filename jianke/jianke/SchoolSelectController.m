...
- (void)viewDidLoad {
    ...
    searchBar.placeholder = @"请输入学校名称查询";
    [searchBar setImage:[UIImage imageNamed:@"main_icon_search_0"] forSearchBarIcon:UISearchBarIconSearch state:UIControlStateNormal];
