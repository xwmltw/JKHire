...
@property (nonatomic, copy, nullable) NSNumber *pay_channel_type; /*!< 支付方式类型 1：APP支付 2：WEB网页支付 3：WAP手机网页支付 */
...
@property (nonatomic, copy, nullable) NSNumber *service_personal_order_id;   /*!< 岗位增值服务订单id */
@property (nonatomic, copy, nullable) NSNumber *insurance_record_id;    /*!<  投保记录id */
@property (nonatomic, copy, nullable) NSNumber *recruit_job_num_order_id; /*!< 在招岗位数id */
@property (nonatomic, copy, nullable) NSNumber *parttime_job_id;    /*!< 岗位Id */
@property (nonatomic, copy, nullable) NSNumber *vip_order_id; /*!< VIP会员订单id */
