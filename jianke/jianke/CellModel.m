...
//    [jkModelArray[3] setStu_apply_resume_time:@(1443501671000)];
    ...
    //对二位数组转换为JKModel
//    NSMutableArray *tmpCellModelArr = [NSMutableArray array];
//    [sortCellModelArray enumerateObjectsUsingBlock:^(NSArray *  _Nonnull tmpArr, NSUInteger idx, BOOL * _Nonnull stop) {
//        NSMutableArray *array = [NSMutableArray array];
//        [tmpArr enumerateObjectsUsingBlock:^(CellModel*  _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
//            [array addObject:obj];
//        }];
//        [tmpCellModelArr addObject:array];
//    }];
