    ...
    switch (self.cellType) {
        ...
        case LookupResumeCellType_sex:{
            ...
            if (model.birthday.length) {
                NSDate *date = [DateHelper getDateFromStr:model.birthday formatter:@"yyyy-MM-dd"];
                NSInteger birthDayInt = [DateHelper compareYearsFromDate:date toDate:[NSDate date]];
                self.labSubTitle.text = [NSString stringWithFormat:@"%ld岁", birthDayInt + 1];
            }else{
        ...
        case LookupResumeCellType_school:{
            ...
            if (model.school_name.length) {
                self.labTitle.text = model.school_name;
            }else{
        ...
        case LookupResumeCellType_professional:{
            ...
            if (model.profession.length) {
                self.labTitle.text = model.profession;
            }else{
        ...
        case LookupResumeCellType_speciality:{
            ...
            if (model.specialty.length) {
                self.labTitle.text = model.specialty;
            }else{
